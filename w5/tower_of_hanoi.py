"""하노이 탑, 작성자: Al Sweigart al@inventwithpython.com
원판 더미를 움직이는 퍼즐 게임
...
TOTAL_DISKS = 3  # 원판이 많을수록 퍼즐은 더 어려워진다
...
"""
    ...
    """towers 딕셔너리는 키 “A”, “B”, “C”와 탑에 쌓인 원판을 표현하는 리스트 
    ...
    while True:  # 이 반복문이 한 번 순회할 때마다 한 턴을 진행한다
        # 탑과 원판을 표시한다
        ...
        if SOLVED_TOWER in (towers["B"], towers["C"]):
            displayTowers(towers)  # 마지막으로 탑을 한 번 더 표시한다
